...
class Player:
   ...
   # funkcja odpowiadająca za ruch kamery
    ...
    # funkcja odpowiadająca za zwiękasznie kata
    ...
    # funkcja odpowiadająca za poruszanie się do przodu
    ...
    # funkcja odpowiadająca za unoszenie kamery
    def get_up(self):
...
# Klasa reprezentująca scnenę
class Scene:


    def __init__(self):

    # Umieszczenie naszego sześcianu w przerstrzeni
        self.containers = [
            FixedComponent(
                position = [0,0,0],
                eulers = [0,0,0]
    ...
    # Umieszczenie w przestrzeni naszego obiektu
        self.monkeys = [
            FixedComponent(
                position = [0,0,0],
                eulers = [0,0,0]
    ...
    # Umiejscowienie źródeł światła
        self.lights = [
            Light(
                position = [0, 0, 10],
                color = [random.uniform(a = 5, b = 5) for x in range(3)]
            ),
            Light(
                position = [-9, -9, 1],
                color = [random.uniform(a = 3, b = 1) for x in range(3)]
            ),
            Light(
                position = [9, -9, 1],
                color = [random.uniform(a = 3, b = 1) for x in range(3)]
...
class App:
    ...
    # funkcja obsługujące naciskane przyciski
    def handleKeys(self):
    ...
    # funkcja obsługująca wydarzenia dotyczące myszki
    ...
    def showFrameRate(self):
        ...
        if (delta >= 1000):
            ...
            self.numFrames = -1
            self.frameTime = float(1000.0 /(framerate + 100))
        self.numFrames += 1
...
class Engine:
    ...
    def create_framebuffer(self):
        ...
        # Informacje dotyczące składowych powierzchni obiektów
...
class ObjMesh:
    ...
    def loadMesh(self, filename):
        ...
        # Odtworzenie obiektu i odczyt danych
        with open(filename,'r') as f:
            ...
            while line:
                ...
                if flag=="v":
                    ...
                    # Obliczanie tangensu i bitangensu
